...
Another example, but generating a maximum projection Latin hypercube design
using the R package `MaxPro`

```{r,fig.height=6,fig.width=8}
X_maxpro <- MaxPro::MaxProLHD(n=20,p=4)$Design
twoD_projections(X_maxpro,ncols=3,grid=TRUE)
```
