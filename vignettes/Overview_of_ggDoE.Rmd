...
6. GLM Diagnostic Plots
7. Half-Normal Plot
8. Interaction Effects Plot for a Factorial Design
9. Main Effects Plot for a Factorial Design
10. Contour Plots for Response Surface Methodology
11. Pareto Plot
12. Two Dimensional Projections of a Latin Hypercube Design
...
glm_diagnostic_plots(glm_model_2, discrete_edm = FALSE, text_width = 50)
```
