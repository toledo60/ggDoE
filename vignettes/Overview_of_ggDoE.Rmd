...
glm_diagnostic_plots(glm_model, discrete_edm = FALSE)
```
...
glm_diagnostic_plots(glm_model_2, discrete_edm = FALSE, standard_errors = TRUE)
```
...
glm_diagnostic_plots(glm_model_2, discrete_edm = FALSE, which_plots = 7:8)
```
