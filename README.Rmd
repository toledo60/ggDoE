...
- [gg_boxplots()](https://ggdoe.netlify.app/reference/gg_boxplots.html): Boxplots used for comparing distributions between groups  
...
- [lambda_plot()](https://ggdoe.netlify.app/reference/lambda_plot.html): Obtain the trace plot of the *t*-statistics after applying Boxcox transformation across a specified sequence of lambda values 
